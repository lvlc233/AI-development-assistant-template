...
description: |
    ...
    The AI assistant is generally not allowed to perform any operations unless they have read the necessary documents to ensure they can safely serve the user in building the project.
